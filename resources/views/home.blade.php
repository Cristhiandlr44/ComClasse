    ...
    <div class="site-container">
        ...
        <div class="hero-collage">
            <div class="left-column">
                <div class="left-stack">
                    <div class="photo-vertical">
                        <img src="{{ asset('imagens_hero/1.jpg') }}" alt="Destaque 1" loading="lazy">
                    </div>
                    <div class="photo-vertical">
                        <img src="{{ asset('imagens_hero/2.jpg') }}" alt="Destaque 2" loading="lazy">
                    </div>
                </div>
                <div class="hero-text">
            ...
            <div class="right-stack">
                <div class="right-top">
                    <img src="{{ asset('imagens_hero/3.jpg') }}" alt="Destaque horizontal" loading="lazy">
                </div>
                <div class="right-bottom">
                    <div class="photo-vertical">
                        <img src="{{ asset('imagens_hero/4.jpg') }}" alt="Destaque 4" loading="lazy">
                    </div>
                    <div class="photo-vertical">
                        <img src="{{ asset('imagens_hero/5.jpg') }}" alt="Destaque 5" loading="lazy">
                    </div>
                </div>
            </div>
        </div>
...
<section id="quem-somos" class="section-block who-values-section">
    <div class="site-container who-block">
        <div class="who-row first">
            <div class="who-media">
                <img src="{{ asset('biografia/1.jpg') }}" alt="Fundadora Com Classe" loading="lazy">
            </div>
            <div class="who-text">
        ...
        <div class="who-row second">
            <div class="who-media outlined">
                <img src="{{ asset('imagens_hero/7.jpg') }}" alt="Equipe Com Classe" loading="lazy">
            </div>
    ...
    <div class="site-container">
        ...
        <div class="atuacao-thumbs">
            <div class="atuacao-item ">
                <img src="{{ asset('imagens_3_secao/Planejamento Detalhado.jpg') }}" alt="Assessoria completa" loading="lazy">
                <p class="font-antic-didone">Assessoria completa e<br>personalizada</p>
            </div>
            <div class="atuacao-item">
                <img src="{{ asset('imagens_3_secao/Execução Perfeita.jpg') }}" alt="Projetos exclusivos" loading="lazy">
                <p class="font-antic-didone">Criação de projetos<br>exclusivos</p>
            </div>
            <div class="atuacao-item">
                <img src="{{ asset('imagens_3_secao/Resultados Excepcionais.jpg') }}" alt="Execução impecável" loading="lazy">
        ...
        <div class="insta-carousel" id="instaCarousel">
            ...
            <div class="insta-track">
                <a class="insta-item" href="https://www.instagram.com/comclassecasamentos/" target="_blank" rel="noopener">
                    ...
                    <img src="{{ asset('imagens_hero/1.jpg') }}" alt="Instagram 1" loading="lazy">
                </a>
                <a class="insta-item" href="https://www.instagram.com/comclassecasamentos/" target="_blank" rel="noopener">
                    <span class="insta-multi"><i class="bi bi-collection"></i></span>
                    <img src="{{ asset('imagens_hero/3.jpg') }}" alt="Instagram 2" loading="lazy">
                </a>
                <a class="insta-item" href="https://www.instagram.com/comclassecasamentos/" target="_blank" rel="noopener">
                    <span class="insta-multi"><i class="bi bi-collection"></i></span>
                    <img src="{{ asset('imagens_hero/5.jpg') }}" alt="Instagram 3" loading="lazy">
                </a>
                <a class="insta-item" href="https://www.instagram.com/comclassecasamentos/" target="_blank" rel="noopener">
                    <span class="insta-multi"><i class="bi bi-collection"></i></span>
                    <img src="{{ asset('imagens_hero/7.jpg') }}" alt="Instagram 4" loading="lazy">
                </a>
                <a class="insta-item" href="https://www.instagram.com/comclassecasamentos/" target="_blank" rel="noopener">
                    <span class="insta-multi"><i class="bi bi-collection"></i></span>
                    <img src="{{ asset('imagens_hero/9.jpg') }}" alt="Instagram 5" loading="lazy">
                </a>
                <a class="insta-item" href="https://www.instagram.com/comclassecasamentos/" target="_blank" rel="noopener">
                    <span class="insta-multi"><i class="bi bi-collection"></i></span>
                    <img src="{{ asset('imagens_hero/11.jpg') }}" alt="Instagram 6" loading="lazy">
                </a>
                <a class="insta-item" href="https://www.instagram.com/comclassecasamentos/" target="_blank" rel="noopener">
                    <span class="insta-multi"><i class="bi bi-collection"></i></span>
                    <img src="{{ asset('imagens_2_secao/Casamento Elegante.jpg') }}" alt="Instagram 7" loading="lazy">
                </a>
                <a class="insta-item" href="https://www.instagram.com/comclassecasamentos/" target="_blank" rel="noopener">
                    <span class="insta-multi"><i class="bi bi-collection"></i></span>
                    <img src="{{ asset('imagens_2_secao/Decoração Sofisticada.jpg') }}" alt="Instagram 8" loading="lazy">
                </a>
                <a class="insta-item" href="https://www.instagram.com/comclassecasamentos/" target="_blank" rel="noopener">
                    <span class="insta-multi"><i class="bi bi-collection"></i></span>
                    <img src="{{ asset('imagens_2_secao/Momentos Especiais.jpg') }}" alt="Instagram 9" loading="lazy">
                </a>
                <a class="insta-item" href="https://www.instagram.com/comclassecasamentos/" target="_blank" rel="noopener">
                    <span class="insta-multi"><i class="bi bi-collection"></i></span>
                    <img src="{{ asset('imagens_3_secao/Planejamento Detalhado.jpg') }}" alt="Instagram 10" loading="lazy">
                </a>
                <a class="insta-item" href="https://www.instagram.com/comclassecasamentos/" target="_blank" rel="noopener">
                    <span class="insta-multi"><i class="bi bi-collection"></i></span>
                    <img src="{{ asset('imagens_3_secao/Execução Perfeita.jpg') }}" alt="Instagram 11" loading="lazy">
                </a>
                <a class="insta-item" href="https://www.instagram.com/comclassecasamentos/" target="_blank" rel="noopener">
                    <span class="insta-multi"><i class="bi bi-collection"></i></span>
                    <img src="{{ asset('imagens_3_secao/Resultados Excepcionais.jpg') }}" alt="Instagram 12" loading="lazy">
                </a>
            </div>
