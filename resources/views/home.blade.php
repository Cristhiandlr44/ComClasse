...
<section class="hero-section-with-collage"
    ...
    <div class="container">
        ...
        <div class="text-center mb-5 hero-logo-wrapper">
            <img src="{{ asset('logo.png') }}" alt="Com Classe Assessoria e Cerimonial" class="hero-logo">
        ...
        <div class="photo-collage-wrapper">
            <div class="photo-collage">
                <div class="collage-photo photo-1">
                    <img src="{{ asset('imagens_hero/1.jpg') }}" alt="Casamento Elegante" loading="lazy">
                </div>
                <div class="collage-photo photo-2">
                    <img src="{{ asset('imagens_hero/2.jpg') }}" alt="Noivos" loading="lazy">
                </div>
                <div class="collage-photo photo-3">
                    <img src="{{ asset('imagens_hero/3.jpg') }}" alt="Mesa Decorada" loading="lazy">
                </div>
                <div class="collage-photo photo-4">
                    <img src="{{ asset('imagens_hero/4.jpg') }}" alt="Festa" loading="lazy">
                </div>
                <div class="collage-photo photo-5">
                    <img src="{{ asset('imagens_hero/5.jpg') }}" alt="Bufê" loading="lazy">
                </div>
                <div class="collage-photo photo-6">
                    <img src="{{ asset('imagens_hero/6.jpg') }}" alt="Cerimônia" loading="lazy">
                </div>
                <div class="collage-photo photo-7">
                    <img src="{{ asset('imagens_hero/7.jpg') }}" alt="Mesa de Evento" loading="lazy">
                </div>
                <div class="collage-photo photo-8">
                    <img src="{{ asset('imagens_hero/8.jpg') }}" alt="Evento Elegante" loading="lazy">
                </div>
                <div class="collage-photo photo-9">
                    <img src="{{ asset('imagens_hero/9.jpg') }}" alt="Casamento" loading="lazy">
                </div>
                <div class="collage-photo photo-10">
                    <img src="{{ asset('imagens_hero/10.jpg') }}" alt="Noivos Elegantes" loading="lazy">
                </div>
                <div class="collage-photo photo-11">
                    <img src="{{ asset('imagens_hero/11.jpg') }}" alt="Decoração" loading="lazy">
                </div>
                <div class="collage-photo photo-12">
                    <img src="{{ asset('imagens_hero/12.jpg') }}" alt="Celebração" loading="lazy">
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="polaroid-gallery d-flex flex-wrap justify-content-center gap-4">
                    <div class="polaroid polaroid-large">
                        <img src="{{ asset('imagens_2_secao/Casamento Elegante.jpg') }}" alt="Casamento Elegante"
                            loading="lazy">
                        <p class="polaroid-caption">Casamento Elegante</p>
                    </div>
                    <div class="polaroid polaroid-large">
                        <img src="{{ asset('imagens_2_secao/Decoração Sofisticada.jpg') }}" alt="Decoração Sofisticada"
                            loading="lazy">
                        <p class="polaroid-caption">Decoração Sofisticada</p>
                    </div>
                    <div class="polaroid polaroid-large">
                        <img src="{{ asset('imagens_2_secao/Momentos Especiais.jpg') }}" alt="Momentos Especiais"
                            loading="lazy">
            ...
            <div id="sobreCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="d-flex justify-content-center">
                            <div class="polaroid polaroid-mobile" style="transform: none;">
                                <img src="{{ asset('imagens_2_secao/Casamento Elegante.jpg') }}"
                    ...
                    <div class="carousel-item">
                        <div class="d-flex justify-content-center">
                            <div class="polaroid polaroid-mobile" style="transform: none;">
                                <img src="{{ asset('imagens_2_secao/Decoração Sofisticada.jpg') }}"
                    ...
                    <div class="carousel-item">
                        <div class="d-flex justify-content-center">
                            <div class="polaroid polaroid-mobile" style="transform: none;">
                                <img src="{{ asset('imagens_2_secao/Momentos Especiais.jpg') }}"
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-5 desktop-gallery">
            <div class="col-12">
                <div class="polaroid-gallery d-flex flex-wrap justify-content-center gap-4">
                    <div class="polaroid polaroid-large">
                        <img src="{{ asset('imagens_3_secao/Planejamento Detalhado.jpg') }}"
                            alt="Planejamento Detalhado" loading="lazy">
                        <p class="polaroid-caption">Planejamento Detalhado</p>
                    </div>
                    <div class="polaroid polaroid-large">
                        <img src="{{ asset('imagens_3_secao/Execução Perfeita.jpg') }}" alt="Execução Perfeita"
                            loading="lazy">
                        <p class="polaroid-caption">Execução Perfeita</p>
                    </div>
                    <div class="polaroid polaroid-large">
                        <img src="{{ asset('imagens_3_secao/Resultados Excepcionais.jpg') }}"
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6 order-lg-2">
                <div class="biography-image-wrapper">
                    <img src="{{ asset('biografia/1.jpg') }}" alt="Biografia" class="img-fluid"
...
<section class="py-5" style="background: linear-gradient(135deg, #2c2c2c 0%, #1a1a1a 100%);">
    <div class="container text-center">
        ...
        <a href="{{ route('contact.questionnaire') }}" class="btn btn-light px-5 py-3"
