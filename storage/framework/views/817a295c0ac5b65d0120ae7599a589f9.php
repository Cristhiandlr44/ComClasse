...
<?php $__env->startSection('title', 'Acesso ao Sistema - Com Classe'); ?>
    ...
    <div class="row g-0 min-vh-100">
        ...
        <div class="col-lg-6 login-image-column">
            <div class="login-image-wrapper">
                ...
                <img src="<?php echo e(asset('imagens_hero/1.jpg')); ?>" alt="Com Classe" class="login-side-image">
                <div class="login-image-content">
                    <img src="<?php echo e(asset('logo.png')); ?>" alt="Com Classe" class="login-image-logo">
            ...
            <div class="login-form-container">
                <div class="login-card">
                    <div class="login-header text-center mb-5">
                        <img src="<?php echo e(asset('logo.png')); ?>" alt="Com Classe" class="login-logo mb-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ComClasse\resources\views/login.blade.php ENDPATH**/ ?>