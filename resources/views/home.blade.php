...
<section id="inicio" class="section-block header-hero">
    <div class="site-container">
        <div class="logo-band">
            <img src="{{ asset('logo.png') }}" alt="Com Classe Assessoria e Cerimonial" class="logo-main">
        </div>
        ...
        <div class="hero-collage">
            <div class="left-column">
                <div class="left-stack">
                    <div class="photo-vertical">
                        <img src="{{ asset('imagens_hero/CABEÇALHO 1.jpg') }}" alt="Destaque 1" loading="lazy">
                    </div>
                    <div class="photo-vertical">
                        <img src="{{ asset('imagens_hero/CABEÇALHO 2.jpg') }}" alt="Destaque 2" loading="lazy">
                    </div>
                </div>
                <div class="hero-text">
            ...
            <div class="right-stack">
                <div class="right-top">
                    <img src="{{ asset('imagens_hero/CABEÇALHO 3.png') }}" alt="Destaque horizontal" loading="lazy">
                </div>
                <div class="right-bottom">
                    <div class="photo-vertical">
                        <img src="{{ asset('imagens_hero/CABEÇALHO 4.jpg') }}" alt="Destaque 4" loading="lazy" class="img-pos-right">
                    </div>
                    <div class="photo-vertical">
                        <img src="{{ asset('imagens_hero/CABEÇALHO 5.jpg') }}" alt="Destaque 5" loading="lazy">
                    </div>
                </div>
            </div>
        </div>
...
<section id="quem-somos" class="section-block who-values-section">
    <div class="site-container who-block">
        <div class="who-row first">
            <div class="who-media">
                <img src="{{ asset('biografia/1.png') }}" alt="Fundadora Com Classe" loading="lazy" class="img-pos-left">
            </div>
            <div class="who-text">
        ...
        <div class="who-row second">
            <div class="who-media outlined">
                <img src="{{ asset('imagens_hero/7.png') }}" alt="Equipe Com Classe" loading="lazy">
            </div>
    ...
    <div class="impact-full">
        <img src="{{ asset('imagens_hero/1.jpg') }}" alt="Celebração com classe" loading="lazy">
    </div>
</section>
    ...
    <div class="site-container">
        ...
        <div class="atuacao-thumbs">
            <div class="atuacao-item ">
                <img src="{{ asset('imagens_3_secao/Planejamento Detalhado.png') }}" alt="Assessoria completa" loading="lazy">
                <p class="font-antic-didone">Assessoria completa e<br>personalizada</p>
            </div>
            <div class="atuacao-item">
                <img src="{{ asset('imagens_3_secao/Execução Perfeita.png') }}" alt="Projetos exclusivos" loading="lazy">
                <p class="font-antic-didone">Criação de projetos<br>exclusivos</p>
            </div>
            <div class="atuacao-item">
                <img src="{{ asset('imagens_3_secao/Resultados Excepcionais.jpg') }}" alt="Execução impecável" loading="lazy" class="img-pos-bottom">
                <p class="font-antic-didone">Execução impecável<br>de tudo que foi sonhado</p>
            </div>
        </div>

        <div class="atuacao-cta">
            <a class="atuacao-btn" href="{{ route('servicos') }}">Quero Saber Mais</a>
        </div>
    </div>
</section>
