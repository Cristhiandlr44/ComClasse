...
<body class="site-editor-body">
    <header class="site-editor-toolbar">
        ...
        <div class="site-editor-toolbar__actions">
            ...
            <form method="POST" action="<?php echo e(route('admin.site.logout')); ?>">
                <?php echo csrf_field(); ?>
    ...
    <div class="site-editor-layout">
        ...
        <main class="site-editor-canvas" id="siteEditorCanvas">
            ...
            <div class="site-editor-page site-body">
                <?php echo $__env->make('partials.home-body', [
                    'editMode' => true,
    ...
    <script>
        window.__SITE_EDITOR__ = {
            ...
            homeContent: <?php echo json_encode($homeContent, 15, 512) ?>,
            routes: {
                saveCollage: <?php echo json_encode(route('admin.site.save.collage'), 15, 512) ?>,
                saveHome: <?php echo json_encode(route('admin.site.save.home'), 15, 512) ?>,
                uploadCollage: <?php echo json_encode(route('admin.site.upload.collage'), 15, 512) ?>,
                uploadHome: <?php echo json_encode(route('admin.site.upload.home'), 15, 512) ?>,
            },
            collageImageBase: <?php echo json_encode($collageImageBase, 15, 512) ?>,
        };
    </script>
    <script src="<?php echo e(asset('js/site-editor.js')); ?>"></script>
